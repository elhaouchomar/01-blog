        ...
        return args -> {
            if (userRepository.count() == 0) {
                ...
                List<UserData> usersData = Arrays.asList(
                    new UserData("Admin", "User", "admin@example.com", "admin", Role.ADMIN, 
                ...
                String[] firstNames = {"Alex", "Jordan", "Casey", "Morgan", "Riley", "Avery", "Quinn", "Blake", "Cameron", "Dakota"};
                String[] lastNames = {"Brown", "Davis", "Miller", "Wilson", "Moore", "Taylor", "Anderson", "Thomas", "Jackson", "White"};
                ...
                if (postRepository.count() == 0) {
                    ...
                    String[] tags = {"java", "spring", "react", "javascript", "docker", "kubernetes", "typescript", "nodejs", "python", "aws"};
                    ...
                    for (int i = 0; i < 50; i++) {
                        ...
                        Post post = Post.builder()
                                .title(postTitles[titleIndex] + (i >= postTitles.length ? " - Part " + (i / postTitles.length + 1) : ""))
                ...
                // We'll create notifications when users follow each other, not by accessing lazy collections
                ...
                // Note: Like notifications will be created automatically when users interact with posts
